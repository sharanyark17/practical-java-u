...
public class CarRestController {
	...
	@PostMapping(path = "/echo",consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.TEXT_PLAIN_VALUE)// consumes JSON data
	public String echo(@RequestBody Car car)// to tell spring this car data is taken from requestbody
	{
